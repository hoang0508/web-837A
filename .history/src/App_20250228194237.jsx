      ...
      <div className="text-2xl font-bold  bg-pink-200 min-h-screen p-10">
        <div className="bg-white shadow-3xl p-3 w-[800px]  my-0 mx-auto rounded-2xl">
          ...
          <div className="my-3">
            ...
            <p className="text-center italic text-base max-w-xs font-light">
              Mời thầy cô và các bạn chọn vào ô dành cho học viên tham gia bình
              chọn hoặc thầy cô tham gia bình chọn cho các thí sinh
            </p>
            <Radio.Group
              value={count}
              options={[
