  ...
  return (
    <>
      <div className="text-2xl font-bold  bg-pink-200 min-h-screen p-10">
        ...
        <div className="bg-gradient-to-tr to-blue-400 from-green-500 p-10 flex justify-center items-center">
          <div className="max-w-[90%]">
            <h1 className="animate-typing border-r-4 border-r-white pr-5 text-5xl text-white font-bold break-words text-center">
